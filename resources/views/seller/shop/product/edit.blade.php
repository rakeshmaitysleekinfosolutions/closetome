        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 bg-white main-shadwo">
                ...
                <div class="enter-conta">
                    ...
                    <form id="frmShopProduct" action="{{route('shop.product.update', [$id])}}" method="post" enctype="multipart/form-data">
                        @csrf
{{--                        <a href="{{route('shop.product') }}" class="btn takfua-back text-white">{{ trans('sentence.business.product.label.back') }}</a>--}}
                        ...
                        <div class="table-responsive">
                            <table id="images" class="table table-striped table-bordered table-hover">
                                ...
                                @if(count($images))
                                    @foreach($images as $image)
                                        <tr id="image-row{{$imageRow}}">
                                            ...
                                            <td class="text-left"><button type="button" data-url="{{route('shop.product.delete.image', [$id])}}" data-row="{{$imageRow}}" data-id="{{$image['id']}}" data-toggle="tooltip" title="Delete" class="btn btn-danger delete"><i class="fa fa-minus-circle"></i></button></td>
                                        </tr>
                                        @php
                                            $imageRow++;
                                        @endphp
                                ...
                                <tr>
                                    <td colspan="3"></td>
                                    <td class="text-left"><button type="button" data-toggle="tooltip" title="Add" class="btn btn-primary addProductImage"><i class="fa fa-plus-circle"></i></button></td>
                                </tr>
                                </tfoot>
                            </table>
                        </div>
