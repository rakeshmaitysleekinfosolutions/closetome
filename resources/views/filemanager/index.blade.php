...
<script>
    var myLabel = myLabel || {};
    myLabel.filemanagerUpload   = '<?php echo url('filemanager/upload');?>';
    myLabel.filemanagerFolder   = '<?php echo url('filemanager/folder');?>';
    myLabel.filemanagerDelete   = '<?php echo url('filemanager/delete');?>';
</script>
